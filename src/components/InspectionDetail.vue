        ...
        <ion-accordion-group class="accordion-group">
            <ion-accordion v-if="inspection.surveyOfDamage">
                ...
                <div class="ion-padding" slot="content">
                    ...
                    <ion-item lines="none">
                        <ion-toggle aria-label="nieuwe schade:" v-model="inspection.surveyOfDamage.newDamage">Nieuwe
                            schade:</ion-toggle>
                    </ion-item>
                    <ion-item lines="none">
            ...
            <ion-accordion v-if="inspection.modification">
                ...
                <div class="ion-padding" slot="content">
                    ...
                    <ion-item lines="none">
                    <ion-select label="Uitgevoerd door" aria-label="uitgevoerd door" placeholder="Selecteer" v-model="inspection.modification.carriedOutBy">
                ...
                <ion-item lines="none">
                    ...
                    <ion-item lines="none">
                    <ion-select aria-label="te ondernemen actie" label="Te ondernemen actie" placeholder="Selecteer" v-model="inspection.modification.actionToTake">
